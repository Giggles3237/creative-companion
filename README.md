...
The studio’s **Make a coloring page** workspace centers on AI coloring-page prompts using the existing artwork
provider, with less intricate, balanced, and more intricate detail choices.
Local JPEG/PNG/WebP uploads and reuse of earlier image creations are also available. Photo conversion runs in the
